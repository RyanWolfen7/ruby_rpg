...
describe Character do
  ...
  describe '#level_up' do
    ...
    it 'should increase Magic from 100 to 108 with default stats' do
      character = Character.new("Name", "Race", "Class")
      character.level_up
    ...
    it 'should increase stamina from 100 to 106 with default stats' do
      character = Character.new("Name", "Race", "Class")
      character.level_up
      expect(character.stamina[:max]).to eq 106
      expect(character.stamina[:current]).to eq 106
    end
  end
